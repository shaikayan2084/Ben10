...
const alienAnimations = {
  ...
  Wildmutt:     { effect: "roar",       label: "Feral Rage" },
  Stinkfly:     { effect: "absorb",     label: "Mucus Stream" },
  "Echo Echo":  { effect: "ripple",     label: "Sonic Boom" },
  Jetray:       { effect: "lightning",  label: "Neuroshock Blast" },
  Brainstorm:   { effect: "hologram",   label: "Brain Zap" },
  Spidermonkey: { effect: "vines",      label: "Web Sling" },
  Goop:         { effect: "absorb",     label: "Goop Sludge" },
  AmpFibian:    { effect: "arcs",       label: "Electro-Squid" },
  Fasttrack:    { effect: "speed",      label: "Speed Blitz" },
  ChamAlien:    { effect: "smoke",      label: "Claw Strike" },
  Eatle:        { effect: "quake",      label: "Chomp Down" },
  Juryrigg:     { effect: "drill",      label: "Gadget Bomb" },
  Bloxx:        { effect: "crystal",    label: "Build Wall" },
  Gravattack:   { effect: "galaxy",     label: "Gravity Well" },
  Crashhopper:  { effect: "shake", label: "Impact Leap" },
  "Ball Weevil": { effect: "tornado",   label: "Goo Grenade" },
  Walkatrout:   { effect: "ripple",     label: "Slippery Escape" },
  "Pesky Dust": { effect: "ghost",      label: "Dream Dust" },
  "Mole-Stache": { effect: "drill",     label: "Mustache Whip" },
  "The Worst":  { effect: "fire",       label: "Tough Hide" },
  "Kickin Hawk": { effect: "speed",     label: "Feathered Fury" },
  Astrodactyl:  { effect: "jets",       label: "Cosmic Dive" },
